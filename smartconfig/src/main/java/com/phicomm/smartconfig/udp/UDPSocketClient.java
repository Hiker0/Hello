package com.phicomm.smartconfig.udp;

import android.util.Log;

import com.phicomm.smartconfig.task.__ISmartConfigTask;
...
public class UDPSocketClient {
	...
	public void sendData(byte[][] data, int offset, int count,
		...
		for (int i = offset; !mIsStop && i < offset + count; i++) {
			...
			try {
				Log.i(TAG, "data[" + i + " +].length = " + data[i].length +" targetHostName="+targetHostName + "targetPort= "+targetPort);
