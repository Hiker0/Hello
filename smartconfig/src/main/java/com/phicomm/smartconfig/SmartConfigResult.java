...
public class SmartConfigResult implements ISmartConfigResult {
	 ...
	 * 
	 * @param isSuc whether the com.phicomm.esptouch task is executed suc
	 * @param bssid the device's bssid
	 * @param inetAddress the device's ip address
	 */
	public SmartConfigResult(boolean isSuc, String bssid, InetAddress inetAddress) {
		this.mIsSuc = isSuc;
		this.mBssid = bssid;
