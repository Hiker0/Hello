...
public class SmartConfigTaskParameter implements ISmartConfigTaskParameter {
	...
	public SmartConfigTaskParameter() {
		...
		mTargetPort = SmartConfigAPI.mTargetPort;
	...
	public int getTargetPort() {
        Log.e("chenhanyuan","======= TargetPort =======  "+mTargetPort);
		return mTargetPort;
	}
