...
public interface ISmartConfigTaskParameter {
	...
	/**
	 * get total repeat time for executing com.phicomm.esptouch task
	 * @return total repeat time for executing com.phicomm.esptouch task
	 */
